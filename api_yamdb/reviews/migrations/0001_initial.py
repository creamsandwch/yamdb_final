# Generated by Django 3.2 on 2023-02-18 15:43
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(max_length=150, unique=True, validators=[django.core.validators.RegexValidator(message='Присутствуют недопустимые символы', regex='^[\\w.@+-]')], verbose_name='Имя пользователя')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('year', models.IntegerField(validators=[reviews.validators.validator_year], verbose_name='Год')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.ForeignKey(help_text='Произведение, к которуму написан отзыв', on_delete=django.db.models.deletion.CASCADE, related_name='reviews', to='reviews.title', verbose_name='Произведение')),
            ],
            options={
                'verbose_name': 'Отзыв',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('review', models.ForeignKey(help_text='Отзыв, к которуму написан комментарий', on_delete=django.db.models.deletion.CASCADE, related_name='comments', to='reviews.review', verbose_name='Отзыв')),
            ],
            options={
